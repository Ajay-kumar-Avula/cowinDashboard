...
class App extends Component {
  ...
  render() {
    const {score, time, category, isTrue, imgUrl} = this.state
      ...
      <div className="bg-con">
        <nav className="nav-bar">
          ...
          <ul className="score-time">
            <li className="score">
              <p className="state-score">Score:{score}</p>
            </li>
            <li className="timer">
              <img
        ...
        {!isTrue && (
          <div className="upper-part">
            <div className="image-headers">
              <img src={imgUrl} className="displayed-img" alt="match" />
        ...
        <ul className="thumbnail-img-list">
          {thumbnailList.map(each => (
            <li>
              ...
              >
                <img src={each.thumbnailUrl} className="thumbnail-img" />
              </button>
            </li>
          ))}
        </ul>
